...
interface CustomAdapter {
  ...
  update: <T>(data: ModelTarget & {
    where: CleanedWhere[];
    update: T;
  }) => Promise<T | null>;
  updateMany: (data: ModelTarget & {
    where: CleanedWhere[];
    update: Record<string, any>;
  }) => Promise<number>;
  findOne: <T>({
   ...
   * guarantee.
   */
  incrementOne?: <T>(data: ModelTarget & {
    where: CleanedWhere[];
    increment: Record<string, number>;
    set?: Record<string, unknown> | undefined;
  }) => Promise<T | null>;
